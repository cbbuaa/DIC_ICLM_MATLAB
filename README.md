...
**Anyone who use the code please cite:**
 "Bin Chen., Erik Jungstedt., `Fast, robust, accurate and large-converge-radius inverse compositional Levenberg–Marquardt algorithm for digital image correlation: principle, validation and open-source toolbox`. (under review)"